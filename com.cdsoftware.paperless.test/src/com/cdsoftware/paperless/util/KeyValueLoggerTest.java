...
import static com.cdsoftware.paperless.test.util.RandomTestUtil.*;
import static com.cdsoftware.paperless.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.cdsoftware.paperless.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.cdsoftware.paperless.util\"");
	}

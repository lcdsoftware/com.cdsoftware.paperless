...
- New callout
    * Name: CName
    * Package: com.cdsoftware.paperless.callout
    * Example: com.cdsoftware.paperless.callout.CStringFormat

- New process
    * Name: PName
    * Package: com.cdsoftware.paperless.process
    * Example: com.cdsoftware.paperless.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: com.cdsoftware.paperless.form
    * Example: com.cdsoftware.paperless.form.FMultiPayment

- New event
    * Name: EName
    * Package: com.cdsoftware.paperless.event
    * Example: com.cdsoftware.paperless.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: com.cdsoftware.paperless.model
    * Example: com.cdsoftware.paperless.model.MTableExample
...
- New callout
    * Create callout in package `com.cdsoftware.paperless.callout`, extends from `CustomCallout`
    * Annotate it with the `@Callout` annotation at class level

- New process
    * Create process in package `com.cdsoftware.paperless.process`, extends from `CustomProcess`
    * Annotate it with the `@Process` annotation at class level

- New form
    * Create form in package `com.cdsoftware.paperless.form`, extends from `CustomForm`
    * Annotate it with the `@Form` annotation at class level

- New event
    * Create event in package `com.cdsoftware.paperless.event`, extends from `CustomEvent`
    * Annotate it with the `@EventTopicDelegate` annotation at class level

- New model (extends form class X)
    * Create model in package `com.cdsoftware.paperless.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`

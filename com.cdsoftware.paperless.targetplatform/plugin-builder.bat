...
call mvn validate -Didempiere.target=com.cdsoftware.paperless.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=com.cdsoftware.paperless.p2.targetplatform %DEBUG_MODE%
